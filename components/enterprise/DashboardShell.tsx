...
const NAV_ITEMS = [
  ...
  { href: "/dashboard/reports", label: "Report Center" },
  { href: "/dashboard/reports/interval-inbound", label: "Interval Inbound" },
  { href: "/dashboard/reports/hubline-status", label: "Hubline Status" },
