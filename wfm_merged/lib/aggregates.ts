 ...
 * contribute — Workbench uses full names, which won't line up with the
 * DG-code join key used elsewhere; its ticket data still lands in
 * excel_rows for the drill-down table.
 */
